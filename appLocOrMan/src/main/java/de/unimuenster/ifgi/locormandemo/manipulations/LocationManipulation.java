 ...
 */
public class LocationManipulation extends Manipulation {
    private double value;

    /**
     * Creates a new LocationManipulation object without specifying a display name.
     ...
     */
    public LocationManipulation(String id, boolean state, String value, Dimension dimension, Type type) {
        this.id = id;
        this.state = state;
    ...
    /**
     * Creates a new LocationManipulation object with specifying a display name.
     * @param id is the ID of the manipulation
     ...
     * @param type of type Type (e.g. accuracy, granularity etc.)
     */
    public LocationManipulation(String id, String name, boolean state, String value, Dimension dimension, Type type) {
